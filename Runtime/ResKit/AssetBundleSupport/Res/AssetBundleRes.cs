...
namespace  Framework
{
    ...
    public class AssetBundleRes : Res
    {
        ...
        private void InitAssetBundleName()
        {
            ...
            {
                mDependResList = AssetBundleSettings.GetAllDependenciesByName(AssetName);
            }
            //if (mDependResList!=null&& mDependResList.Length>0) Debug.LogError(mDependResList[0]);
        }
        ...
        public override IEnumerator DoLoadAsync(System.Action finishCallback)
        {
            ...
            else
            {
                ...
                if (PlatformFromUnityToDll.IsWebGL)
                {
