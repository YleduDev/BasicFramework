...
namespace Framework
{
    ...
    public class CameraOrbit : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            defaultCameraYaw = cameraYaw;
            defaultCameraPitch = cameraPitch;
            var input = SimpleInputManager.Instance;

            TypeEventSystem.Global.Register<CameraPitchYawEvent>(CameraPitchYawCallBack).UnRegisterWhenGameObjectDestroyed(gameObject);


        }

        private void CameraPitchYawCallBack(CameraPitchYawEvent pitchYawEvent) {

            setCameraYaw = defaultCameraYaw + pitchYawEvent.CameraYaw;
            setCameraPitch = defaultCameraPitch + pitchYawEvent.CameraPitch;
        }
...
public class CameraPitchYawEvent
{
