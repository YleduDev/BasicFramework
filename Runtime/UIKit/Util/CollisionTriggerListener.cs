...
namespace Framework
{
    ...
    public class CollisionTriggerListener : MonoBehaviour
    {
        ...
        public void RegisterCollisionEnter(UnityAction<UnityEngine.Collision> action) { Register(EventName.CollisionEnter, action); }
        public void UnRegisterCollisionEnter(UnityAction<UnityEngine.Collision> action) { UnRegister(EventName.CollisionEnter, action); }
        private void OnCollisionEnter(UnityEngine.Collision collision) { Dispatch(EventName.CollisionEnter, collision); }
        
        public void RegisterCollisionExit(UnityAction<UnityEngine.Collision> action) { Register(EventName.CollisionExit, action); }
        public void UnRegisterCollisionExit(UnityAction<UnityEngine.Collision> action) { UnRegister(EventName.CollisionExit, action); }
        private void OnCollisionExit(UnityEngine.Collision collision) { Dispatch(EventName.CollisionExit, collision); }

        public void RegisterCollisionStay(UnityAction<UnityEngine.Collision> action) { Register(EventName.CollisionStay, action); }
        public void UnRegisterCollisionStay(UnityAction<UnityEngine.Collision> action) { UnRegister(EventName.CollisionStay, action); }
        private void CollisionStay(UnityEngine.Collision collision) { Dispatch(EventName.CollisionStay, collision); }
