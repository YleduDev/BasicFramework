...
namespace Framework
{
    public class ILBehaviourCodeTemplate
    {
        public static void Write(string name, string scriptsFolder, string ns)
        {
            ...
            writer.WriteLine("{");
            writer.WriteLine("\tpublic partial class {0}: ILComponent".FillFormat(name));
            writer.WriteLine("\t{");
            writer.WriteLine("\t\tprotected override void OnStart()");
            writer.WriteLine("\t\t{");
            writer.WriteLine("\t\t\t// Code Here");
            writer.WriteLine("\t\t\t SetupBinds();");
            writer.WriteLine("\t\t}");
            writer.WriteLine();
            writer.WriteLine("\t\tprotected override void OnDestroy()");
            writer.WriteLine("\t\t{");
    ...
    public class ILBehaviourCodeDesignerTemplate
    {
            ...
            string ns)
        {
            ...
            writer.WriteLine("\t\t{");
            writer.WriteLine("\t\t\tif (!transform) transform = base.transform;");
            writer.WriteLine("\t\t\tif (!gameObject) gameObject = base.gameObject;");
            foreach (var bindInfo in panelCodeInfo.BindInfos)
            {
