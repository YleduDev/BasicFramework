...
namespace Framework
{
    ...
    public class ILKitBehaviourInspector :UnityEditor.Editor
    {
        class LocaleText
        {
        ...
        private void OnEnable()
        {
            ...
            {
                mCodeGenerateInfo.Namespace = "Framework";
            }

            if (mCodeGenerateInfo.ScriptsFolder.IsNullOrEmpty())
            {
                mCodeGenerateInfo.ScriptsFolder = "Assets/Scripts";
            }
            ...
            new HorizontalLayout()
                ...
                .AddChild(EasyIMGUI.TextField().Text(mCodeGenerateInfo.Namespace).Self(v =>
                {
            ...
            new HorizontalLayout()
                ...
                .AddChild(EasyIMGUI.TextField().Text(mCodeGenerateInfo.ScriptName).Self(v =>
                {
                    v.Content.Bind((newValue) =>
                    {
            ...
            new HorizontalLayout()
                ...
                .AddChild(EasyIMGUI.TextField().Text(mCodeGenerateInfo.ScriptsFolder).Self(v =>
                {
                    v.Content.Bind((newValue) =>
                    {
